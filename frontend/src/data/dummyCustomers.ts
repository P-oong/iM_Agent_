...
export const DUMMY_CUSTOMERS: DummyCustomer[] = [
  ...
  // ── 시연 전용 고객 (Screen0156 이름 조회 연동) ──────────
  {
    id: 'DEMO-1',
    residentIdFront: '940301',
    name: '김민지',
    age: 32,
    gender: '여',
    job: '직장인',
    ...
    products: ['수시입출금', '체크카드'],
    accounts: [
      { number: '013-11001-00001', product: '수시입출금', balance: 5_800_000, status: '정상' },
      { number: '013-11001-00002', product: '체크카드',   balance: 0,         status: '정상' },
    ],
    recentTransactions: [
      { date: '2026-04-28', desc: '전세보증금 이체',   amount: -50_000_000 },
      { date: '2026-04-25', desc: '타행 급여입금',     amount:  3_200_000 },
      { date: '2026-04-20', desc: '생활비 카드(타행)', amount: -950_000 },
      { date: '2026-04-15', desc: '보험료 자동이체',   amount: -180_000 },
    ],
    notes: '전세 계약 예정. 급여·생활비 카드 모두 타행 중심. 이번 내점 목적: 전세보증금 이체한도 상향.',
  },
  {
    id: 'DEMO-2',
    residentIdFront: '810502',
    name: '박성호',
    age: 45,
    gender: '남',
    job: '음식점 운영 (개인사업자)',
    ...
    accounts: [
      { number: '013-12001-00001', product: '사업자통장', balance: 8_200_000, status: '정상' },
    ],
    recentTransactions: [
      { date: '2026-04-28', desc: '식자재 대금',         amount: -14_500_000 },
      { date: '2026-04-25', desc: '카드매출입금(타행)',   amount:  27_000_000 },
      { date: '2026-04-20', desc: '임대료 이체',         amount:  -3_500_000 },
      { date: '2026-04-15', desc: '인건비',              amount:  -9_000_000 },
    ],
    notes: '월 매출 3,800만원. 카드매출 2,700만원이 타행으로 입금. 이번 내점 목적: 거래내역 발급(세무신고 추정).',
  },
  {
    id: 'DEMO-3',
    residentIdFront: '660101',
    name: '대구정밀부품(주)',
    age: 0,
    gender: '남',
    job: '자동차 부품 제조업 (법인)',
    ...
    accounts: [
      { number: '013-13001-00001', product: '법인 입출금통장', balance: 73_000_000, status: '정상' },
    ],
    recentTransactions: [
      { date: '2026-04-28', desc: '원자재 대금',    amount: -260_000_000 },
      { date: '2026-04-25', desc: '매출 입금',      amount:  480_000_000 },
      { date: '2026-04-20', desc: '급여 일괄이체',  amount:  -95_000_000 },
      { date: '2026-04-15', desc: '기존 대출 이자', amount:   -1_200_000 },
    ],
